//
//  ProUserEditProfilePhoneNumberCellAdapter.m
//  TagALong
//
...
#import "ProUserEditProfilePhoneNumberCellAdapter.h"
#import "ProUserEditProfileTableViewCell.h"
#import "UIView+Nib.h"
#import "UIColor+AppColors.h"
#import "UIFont+HelveticaNeue.h"

@interface ProUserEditProfilePhoneNumberCellAdapter() <ProUserEditProfileTableViewCellOutput, UITextFieldDelegate>

@property (nonatomic, weak) id <ProUserEditProfilePhoneNumberCellAdapterOutput> output;

@end

@implementation ProUserEditProfilePhoneNumberCellAdapter
...
- (UITableViewCell*)cellForTableView:(UITableView*)tableView atIndexPath:(NSIndexPath*)indexPath {
    ...
    cell.textField.text = [self.output phoneNumber];
    
    NSDictionary *attributes = @{NSForegroundColorAttributeName : UIColor.placeholderColor, NSFontAttributeName : [UIFont textFont]};
    cell.textField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"Phone number" attributes:attributes];
...
- (void)textDidChange:(NSString*)text {
    if ([self.output respondsToSelector:@selector(phoneNumberDidChange:)]) {
        [self.output phoneNumberDidChange:text];
    }
}
