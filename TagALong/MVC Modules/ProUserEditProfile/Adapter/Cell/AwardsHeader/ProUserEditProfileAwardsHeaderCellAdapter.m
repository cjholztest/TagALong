//
//  ProUserEditProfileAwardsHeaderCellAdapter.m
//  TagALong
//
...
@implementation ProUserEditProfileAwardsHeaderCellAdapter
...
- (UITableViewCell*)cellForTableView:(UITableView*)tableView atIndexPath:(NSIndexPath*)indexPath {
    ...
    cell.titleLabel.text = @"Performances/Results".uppercaseString;
