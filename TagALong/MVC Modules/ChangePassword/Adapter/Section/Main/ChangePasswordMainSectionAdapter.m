//
//  ChangePasswordMainSectionAdapter.m
//  TagALong
//
...
#import "ChangePasswordMainSectionAdapter.h"

@implementation ChangePasswordMainSectionAdapter

#pragma mark - ProUserSignUpSectionAdapter

- (void)registerCellsInTableView:(UITableView*)tableView {
    for (id <ChangePasswordCellAdapter> cell in self.cellAdapters) {
