...
- (void)commonInit {
    ...
    [self.prevButton setBackgroundImage:[[UIImage imageNamed:@"ic_arrowleft"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
    ...
    [self.nextButton setBackgroundImage:[[UIImage imageNamed:@"ic_arrow_right"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate] forState:UIControlStateNormal];
