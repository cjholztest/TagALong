...
- (void)commonInit {
    ...
    self.weekdayHeaderWeekendTextColor = [UIColor whiteColor];
    self.componentTextColor = [UIColor whiteColor];
    self.highlightedComponentTextColor = [UIColor whiteColor];
    self.selectedIndicatorColor = [UIColor colorWithRed:1 green:0.5 blue:0.5 alpha:1];
    self.todayIndicatorColor = [UIColor colorWithRed:1 green:0.8 blue:0 alpha:1];
